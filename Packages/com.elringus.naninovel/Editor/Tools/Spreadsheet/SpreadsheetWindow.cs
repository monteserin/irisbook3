...
namespace Naninovel.Spreadsheet
{
    public class SpreadsheetWindow : EditorWindow
    {
        ...
        private static readonly GUIContent inputScriptFolderContent = new("Input Scripts Folder", "Folder containing source scenario script files (.nani).");
        ...
        private void OnGUI ()
        {
            ...
            EditorGUILayout.LabelField("The tool to export/import scenario script and managed text localizations to/from spreadsheets.", EditorStyles.wordWrappedMiniLabel);
